...
Constinue the story from the narrators perspective.
`;
  }
...
- **NPCs**: Create NPCs that are survival-focused with realistic motives (e.g., "The scavenger is desperate for food and might turn hostile if you refuse, but he could share knowledge of where or where not to go.").
...
- **Goal**: Complete a quest (e.g., "Kill the demon threatening the kingdom."), with the quest’s scope and steps determined by the setting (e.g., "You need to find three artifacts to weaken the demon."). Track progress through narrative milestones (e.g., "You’ve found one of three artifacts needed to confront the demon."). Update progress in the narrative (e.g., "You’ve found an artifact, bringing your total to ${progress.artifactsFound || 0}.").
`;
      break;
    case 'horror':
      changeableRules = `
